...
begin
  ...
  case FIn.FCommand of
    ...
    cBC_WeChat_complete_shoporders : Result := complete_shoporders(nData);
...
begin
  ...
  begin
    ...
    FAppid := nTmp.ValueAsString;

    nTmp := nNode.FindNode('Bindcustomerid');
    FBindcustomerid := nTmp.ValueAsString;

    nTmp := nNode.FindNode('Namepinyin');
    FNamepinyin := nTmp.ValueAsString;

    nTmp := nNode.FindNode('Email');
    FEmail := nTmp.ValueAsString;

    nTmp := nNode.FindNode('Openid');
    FOpenid := nTmp.ValueAsString;

    nTmp := nNode.FindNode('Binddate');
    FBinddate := nTmp.ValueAsString;
  end;  
end;
