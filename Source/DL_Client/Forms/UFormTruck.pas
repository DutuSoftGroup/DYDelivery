...
begin
  ...
  begin
    ...
    EditIDCard.Text:= FieldByName('T_OwnerIDCard').AsString;
    EditSerial.Text:= FieldByName('T_SerialNO').AsString;
...
begin
  ...
  nStr := MakeSQLByStr([SF('T_Truck', nTruck),
          ...
          SF('T_OwnerIDCard', EditIDCard.Text),
          SF('T_SerialNO', EditSerial.Text),
